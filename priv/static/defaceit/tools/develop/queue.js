...
Defaceit.Queue.prototype = {
	...
	list: function() {
	    Defaceit.request('http://defaceit.ru/queue/list/' + this.queue + '/' + this.next_call_id());
	    return this;
	},
	...
	push: function(message, callback) {
	    ...
	    Defaceit.request('http://defaceit.ru/queue/push/' + this.queue + '/'  + cid +'/'+ encodeURIComponent(message));
	    return cid;
	},
	
	top: function() {
	    Defaceit.request('http://defaceit.ru/queue/top/' + this.queue + '/'  + this.next_call_id());
	    return this;
	},
