    ...
    [{description,"Defaceit application for chnageable interfaces"},
     ...
     {modules,
         [defaceit,edefaceit_incoming_mail_controller,
          edefaceit_outgoing_mail_controller,edefaceit_hello_controller,
          edefaceit_main_controller,edefaceit_app_controller,widget,
          edefaceit_view_lib_tags,edefaceit_custom_filters,
          edefaceit_custom_tags,edefaceit_view_main_index_html,
